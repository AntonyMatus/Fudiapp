...
<main class="admin-main  ">
    <div class="container-fluid">
        <div class="row ">
                ...
                <div class="row align-items-center m-h-100">
                    <div class="mx-auto col-md-3">
                        <div class="p-b-20 text-center">
                            <p>
                                <img src="{{ Asset('assets/img/login2.png') }}" width="20%" alt="">
                            </p>
                        </div>
            ...
            <!-- <div class="col-lg-7 d-none d-md-block bg-cover bg-white" style="background-image: url('{{Asset('assets/img/icon.png') }}');"></div> -->
        </div>
    </div>
</main>
